import{j as t}from"./vendor-dnd-Dyg3YmpX.js";import{r as i,a as D}from"./vendor-react-ChHgBwk8.js";const Y=120,z=.5;function w(e){return Array.from(e.querySelectorAll('a[href], button:not([disabled]), textarea, input:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])')).filter(r=>!r.closest('[aria-hidden="true"]'))}const T=`
